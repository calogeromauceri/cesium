...
/**
 * Retrieves a cached position for the specified key from this tile's position cache.
 *
 * @memberof QuadtreeTile
 *
 * @param {string} cacheKey - The key for the cache entry, typically generated by _getCacheKey.
 * @returns {Object|undefined} The cached position data (e.g. an object containing positionOnEllipsoidSurface), or undefined if not found.
 */
